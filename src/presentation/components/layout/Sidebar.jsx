...
/**
 * Left sidebar — contains the logo, navigation links, and user identity.
 * @param {object} props
 * @param {string} props.active - Active page ID ('stok' | 'ustalar')
 * @param {(id: string) => void} props.onNav - Page-change handler
 */
